...
class OpenTableLocalCache(
    ...
    fun insert(repos: List<Repo>, insertFinished: () -> Unit) {
        ioExecutor.execute {
            Log.d("OpenTableLocalCache", "inserting ${repos.size} repos")
     ...
     * multiple words separated by spaces, then we're emulating the OpenTable API behavior and allow
     * any characters between the words.
     * @param name repository name
     */
    fun restaurantsByCity(name: String): DataSource.Factory<Int, Repo> {
